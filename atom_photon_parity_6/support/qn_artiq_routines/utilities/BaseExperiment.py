...
class BaseExperiment:
    ...
    def __init__(self, experiment: EnvExperiment):
        ...
        devices_file = os.path.join(CONFIG_ROOT, self.node, "device_aliases.json")
    ...
    def build(self):
        ...
        self.experiment.in_health_check = False
        self.experiment.SPCM0_RO1_in_health_check = 0
    ...
    def prepare(self):
        ...
        config_file = os.path.join(CONFIG_ROOT, self.node, "feedback_channels.json")
    ...
    def initialize_datasets(self):
        ...
        self.experiment.set_dataset("SPCM0_RO1_in_health_check", [0], broadcast=True)
