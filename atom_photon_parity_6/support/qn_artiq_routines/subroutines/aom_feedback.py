...
CONFIG_ROOT = os.path.join(os.path.dirname(os.path.dirname(__file__)), "utilities", "config")
...
class AOMPowerStabilizer:
    ...
    def __init__(self, experiment, dds_names, iterations=10, averages=1, leave_AOMs_on=False,
        ...
        config_file = os.path.join(CONFIG_ROOT, self.exp.which_node, "feedback_channels.json")
