...
# Device DB for running parity 6 on a normal SNAQ node-1 bitstream without the
# atom-photon entangler overlay. The RTIO channel order differs from
# device_db.py after ttl0_counter..ttl3_counter because there is no entangler
# control RTIO channel.
