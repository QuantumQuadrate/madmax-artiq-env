...
# Autogenerated for the atom_photon_parity_6 variant
...
# dio0[0] -> RTIO channel 0x000004 -> ttl0 (input)
...
# dio0[0] -> RTIO channel 0x000005 -> ttl0_counter (counter)
...
# dio0[1] -> RTIO channel 0x000006 -> ttl1 (input)
...
# dio0[1] -> RTIO channel 0x000007 -> ttl1_counter (counter)
...
device_db["ttl_urukul1_sync"] = {
    ...
    "module": "artiq.coredevice.ttl",
    "class": "TTLClockGen",
    "arguments": {"channel": 0x000029, "acc_width": 4}
}
...
device_db["ttl_urukul2_sync"] = {
    ...
    "module": "artiq.coredevice.ttl",
    "class": "TTLClockGen",
    "arguments": {"channel": 0x000030, "acc_width": 4}
}
