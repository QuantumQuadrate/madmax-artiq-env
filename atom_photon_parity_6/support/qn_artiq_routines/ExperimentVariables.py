...
class ExperimentVariables(EnvExperiment):
    ...
    def build(self):
        ...
        self.vars_list = [
            ...
            Variable("require_atom_loading_to_advance_in_single_photon_exp", False, BooleanValue, {}, "single photon experiment"),

            Variable("n_excitation_attempts", 5, NumberValue, {'type': 'int', 'ndecimals': 0, 'step': 1, 'scale': 1},
            ...
            Variable("p_FORT_RO", 0.8, NumberValue,
                     ...
                     "FORT AOM - outdated"),
            Variable("p_FORT_PGC", 0.8, NumberValue, {'type': 'float', 'unit': "(fractional)", 'scale': 1, 'ndecimals': 2},
                     "FORT AOM - outdated"),
            Variable("p_FORT_blowaway", 0.7, NumberValue,
                     {'type': 'float', 'unit': "(fractional)", 'scale': 1, 'ndecimals': 2},
                     "FORT AOM - outdated"),
            Variable("p_FORT_OP", 0.8, NumberValue,
                     {'type': 'float', 'unit': "(fractional)", 'scale': 1, 'ndecimals': 2},
                     "FORT AOM - outdated"),

            # Cooling double pass AOM
            Variable("f_cooling_DP_MOT", 112.0 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "Cooling double pass AOM"),
            Variable("f_cooling_DP_RO", 115.0 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "Cooling double pass AOM"),
            Variable("f_cooling_DP_PGC", 130.0 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "Cooling double pass AOM"),
            Variable("f_cooling_DP_PGC_optimization", 130.0 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "Cooling double pass AOM"),
            Variable("f_cooling_DP_resonant_2_to_3", 104.25 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "Cooling double pass AOM"),
            Variable("f_cooling_DP_blowaway", 104.25 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz'},
                     "Cooling double pass AOM"),
            ...
            Variable("p_cooling_DP_PGC", 0.9, NumberValue, {'type': 'float', 'unit': "(fractional 0.0 to 1.0)",
                                                            'scale': 1, 'ndecimals': 2},
                     "Cooling double pass AOM"),
            Variable("p_cooling_DP_PGC_optimization", 0.9, NumberValue, {'type': 'float', 'unit': "(fractional 0.0 to 1.0)",
                                                            'scale': 1, 'ndecimals': 2},
                     "Cooling double pass AOM"),

            # D1 optical pumping, pumping repumper, and excitation
            Variable("f_D1_pumping_DP", 373.075 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 3},
                     "OP and excitation AOMs"),
            Variable("p_D1_pumping_DP", -1.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "OP and excitation AOMs"),
            ...
            Variable("p_AOM_A1", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            Variable("p_AOM_A1_optimization", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            Variable("AOM_A2_freq", 78.49 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 3},
                     "Fiber AOMs"),
            Variable("p_AOM_A2", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            Variable("p_AOM_A2_optimization", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            Variable("AOM_A3_freq", 78.50 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 3},
                     "Fiber AOMs"),
            Variable("p_AOM_A3", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            Variable("p_AOM_A3_optimization", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            Variable("AOM_A4_freq", 78.51 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 3},
                     "Fiber AOMs"),
            Variable("p_AOM_A4", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            Variable("p_AOM_A4_optimization", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            Variable("AOM_A5_freq", 78.52 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 3},
                     "Fiber AOMs"),
            Variable("p_AOM_A5", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            Variable("p_AOM_A5_optimization", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            Variable("AOM_A6_freq", 78.53 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 3},
                     "Fiber AOMs"),
            Variable("p_AOM_A6", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            Variable("p_AOM_A6_optimization", -13.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Fiber AOMs"),
            ...
            Variable("f_microwaves_00_dds", 334.682 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 7},
                     "Microwaves"),
            Variable("f_microwaves_01_dds", 338.2 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 7},
                     "Microwaves"),
            Variable("f_microwaves_11_dds", 341.73 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 7},
                     "Microwaves"),
            Variable("f_microwaves_m10_dds", 331.156 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 7},
                     "Microwaves"),
            Variable("f_microwaves_m11_dds", 331.92 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 7},
                     "Microwaves"),
            Variable("f_MW_RF_dds", 2.761 * MHz, NumberValue, {'type': 'float', 'unit': 'MHz', 'ndecimals': 7},
                     "Microwaves"),
            Variable("p_MW_RF_dds", -8.0, NumberValue, {'type': 'float', 'unit': "dBm", 'scale': 1, 'ndecimals': 1},
                     "Microwaves"),
            Variable("t_microwave_pulse", 4.5 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Microwaves"),
            Variable("t_microwave_00_pulse", 16.0 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Microwaves"),
            ...
            Variable("t_MW_11_ramp", 2 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Microwaves"),

            # Coils - MOT
            Variable("AZ_bottom_volts_MOT", 7.279, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals':3},
                     "MOT coil settings"),
            Variable("AZ_top_volts_MOT", 7.694, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals':3},
                     "MOT coil settings"),
            Variable("AX_volts_MOT", 0.115, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals':3},
                     "MOT coil settings"),
            Variable("AY_volts_MOT", -0.291, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals':3},
                     "MOT coil settings"),


            # Coils - PGC
            Variable("AZ_bottom_volts_PGC", -0.196, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals':3},
                     "MOT coil settings"),
            Variable("AX_volts_PGC", 0.115, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals':3},
                     "MOT coil settings"),
            Variable("AY_volts_PGC", -0.291, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals':3},
                     "MOT coil settings"),

            Variable("AZ_bottom_volts_PGC_optimization", -0.196, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals': 3},
                     "MOT coil settings"),
            Variable("AX_volts_PGC_optimization", 0.115, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals': 3},
                     "MOT coil settings"),
            Variable("AY_volts_PGC_optimization", -0.291, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals': 3},
                     "MOT coil settings"),
            ...
            Variable("AX_volts_OP", 0.04, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals': 3},
                     "Science coil settings"),
            Variable("AY_volts_OP", 5.0, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals': 3},
                     "Science coil settings"),
            ...
            Variable("AY_volts_blowaway", 5.0, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals': 3},
                     "Science coil settings"),
            Variable("AZ_bottom_volts_microwave", -0.22, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals': 3},
                     "Science coil settings"),
            Variable("AX_volts_microwave", 0.04, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals': 3},
                     "Science coil settings"),
            Variable("AY_volts_microwave", 5.0, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals': 3},
                     "Science coil settings"),
            ...
            Variable("t_BA_chop_period", 1.2 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("duty_cycle_OP", 0.2, NumberValue, {'type': 'float', 'unit': "(fractional 0.0 to 1.0)",
                                                             'scale': 1, 'ndecimals': 2}, "Timing"),
            Variable("duty_cycle_FORT", 0.65, NumberValue, {'type': 'float', 'unit': "(fractional 0.0 to 1.0)",
                                                          'scale': 1, 'ndecimals': 2}, "Timing"),
            Variable("chop_RO_FORT_off", 0.5 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("chop_RO_pulse_length", 0.4 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("chop_RO_pulse_offset", 0.2 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("chop_RO_gate_length", 0.5 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),
            Variable("chop_RO_gate_offset", 0.1 * us, NumberValue, {'type': 'float', 'unit': 'us'}, "Timing"),

            Variable("t_recooling", 15 * ms, NumberValue, {'type': 'float', 'unit': 'ms'}, "Timing"),
            Variable("t_photon_collection_time", 200 * ns, NumberValue, {'type': 'float', 'unit': 'ns'}, "Timing"),
            Variable("gate_start_offset_mu", 820, NumberValue, {'type': 'int', 'ndecimals': 0, 'scale': 1, 'step': 1},
                     "Timing"),
            ...
            Variable("require_D1_lock_to_advance", True, BooleanValue, {}, "Booleans"),
            ...
            Variable("set_point_PD2_AOM_A2", 0.0515, NumberValue, {'type': 'float','ndecimals':4}, "Set points"),
            Variable("set_point_PD3_AOM_A3", 0.0332, NumberValue, {'type': 'float','ndecimals':4}, "Set points"),
            Variable("set_point_PD4_AOM_A4", 0.0453, NumberValue, {'type': 'float','ndecimals':4}, "Set points"),
            Variable("set_point_PD5_AOM_A5", 0.0236, NumberValue, {'type': 'float','ndecimals':4}, "Set points"),
            Variable("set_point_PD6_AOM_A6", 0.0381, NumberValue, {'type': 'float','ndecimals':4}, "Set points"),
            Variable('set_point_FORT_APD_loading', 0.06, NumberValue, {'type': 'float', 'ndecimals': 5}, "Set points"),
            Variable('set_point_FORT_APD_science', 0.04, NumberValue, {'type': 'float', 'ndecimals': 5}, "Set points"),
            Variable('set_point_FORT_MM_loading', 0.3, NumberValue, {'type': 'float','ndecimals':3}, "Set points"),
            Variable('set_point_FORT_MM_science', 0.25, NumberValue, {'type': 'float', 'ndecimals': 3}, "Set points"),
            Variable('set_point_D1_SP', 0.2, NumberValue, {'type': 'float', 'ndecimals': 3}, "Set points"),
            ...
            Variable("enable_laser_feedback", True, BooleanValue, {}, "Laser feedback"),
            Variable("slow_feedback_dds_list", "[]", StringValue, {}, "Laser feedback"),
            Variable("fast_feedback_dds_list", "['dds_AOM_A1', 'dds_AOM_A2', 'dds_AOM_A3', "
                                          "'dds_AOM_A4','dds_AOM_A5',"
                                      "'dds_AOM_A6','dds_FORT']", StringValue, {}, "Laser feedback"),
            Variable("aom_feedback_averages", 10, NumberValue, {'type': 'int', 'ndecimals': 0, 'scale': 1, 'step':1},
                     "Laser feedback"),
            Variable("aom_feedback_iterations", 15, NumberValue, {'type': 'int', 'ndecimals': 0, 'scale': 1, 'step':1},
                     "Laser feedback"),

            #RIGOL
            Variable("Rigol_carrier_frequency", 65 * kHz, NumberValue, {'type': 'float', 'unit': 'kHz', 'ndecimals': 3},
                     "Rigol DG1022Z settings"),
            Variable("Rigol_FM_deviation", 35 * kHz, NumberValue, {'type': 'float', 'unit': 'kHz', 'ndecimals': 3},
                     "Rigol DG1022Z settings"),
            Variable("Rigol_V_DC", 0.595, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals': 3},
                     "Rigol DG1022Z settings"),
            Variable("Rigol_V_pp", 0.05, NumberValue, {'type': 'float', 'unit': 'V', 'ndecimals': 3},
                     "Rigol DG1022Z settings"),
            ...
            Variable("target_780_HWP", 0.0, NumberValue,
                     {'type': 'float', 'ndecimals': 2, 'scale': 1, 'step': 0.5},
                     "K10CR1 780 waveplates"),
            Variable("target_780_QWP", 0.0, NumberValue,
                     {'type': 'float', 'ndecimals': 2, 'scale': 1, 'step': 0.5},
                     "K10CR1 780 waveplates"),
            Variable("move_780_HWP_by", 0.0, NumberValue,
                     {'type': 'float', 'ndecimals': 2, 'scale': 1, 'step': 0.5},
                     "K10CR1 780 waveplates"),
            Variable("move_780_QWP_by", 0.0, NumberValue,
                     {'type': 'float', 'ndecimals': 2, 'scale': 1, 'step': 0.5},
                     "K10CR1 780 waveplates"),


            Variable("target_852_HWP", 0.0, NumberValue,
                     {'type': 'float', 'ndecimals': 2, 'scale': 1, 'step': 0.5},
                     "K10CR1 852 waveplates"),
            Variable("target_852_QWP", 0.0, NumberValue,
                     {'type': 'float', 'ndecimals': 2, 'scale': 1, 'step': 0.5},
                     "K10CR1 852 waveplates"),
            Variable("move_852_HWP_by", 0.0, NumberValue,
                     {'type': 'float', 'ndecimals': 2, 'scale': 1, 'step': 0.5},
                     "K10CR1 852 waveplates"),
            Variable("move_852_QWP_by", 0.0, NumberValue,
                     {'type': 'float', 'ndecimals': 2, 'scale': 1, 'step': 0.5},
                     "K10CR1 852 waveplates"),


            Variable("best_852HWP_to_max", 2.0, NumberValue,
                     {'type': 'float', 'ndecimals': 3, 'scale': 1, 'step': 0.5},
                     "K10CR1 852 waveplates"),
            Variable("best_852QWP_to_max", 2.5, NumberValue,
                     {'type': 'float', 'ndecimals': 3, 'scale': 1, 'step': 0.5},
                     "K10CR1 852 waveplates"),
            Variable("best_852_power", 0.398, NumberValue,
                     {'type': 'float', 'ndecimals': 3, 'scale': 1, 'step': 0.5},
                     "K10CR1 852 waveplates"),
            Variable("best_852_power_ref", 0.398, NumberValue,
                     {'type': 'float', 'ndecimals': 3, 'scale': 1, 'step': 0.5},
                     "K10CR1 852 waveplates"),
